...
public class SingleUseRouteActivity extends AppCompatActivity {
        ...
        settingsButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(SingleUseRouteActivity.this, v);
                        popup.setOnMenuItemClickListener(SingleUseRouteActivity.this::settingsMenuClick);
    ...
    public void onDrawFrame(SampleRender render) {
        ...
        //Lani
        Log.e(TAG, "Lani says: " + frame.getCamera().getPose().extractTranslation().tx());

        leaveAnchor(frame, camera);
    ...
    private void leaveAnchor(Frame frame, Camera camera){
        ...
        */
        ...
        float z = frame.getCamera().getPose().extractTranslation().tz();
...
class WrappedAnchor1 {
    ...
    public WrappedAnchor1(Anchor anchor, Trackable trackable) {
        this.anchor = anchor;
